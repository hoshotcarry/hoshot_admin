	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" id="coupons_nam" name="coupons_name" value="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                                <select class="input-text" id="parent_id" name="parent_id">
                                    ...
                                    <option vlaue="<?php echo $cate['id'];?>"><?php echo $cate['title'];?></option>
                                    <?php }?>
                                </select>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
                            <textarea name="coupons_dec" id="description" cols="90" rows="6"></textarea>
			</div>
		</div>
