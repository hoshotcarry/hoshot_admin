...
<form class="form form-horizontal" id="form-member-add" name="form1" method="post" action="" onsubmit="return toVaild()"  enctype="multipart/form-data">
<div class="warp">
    ...
    <div class="_line formControls col-xs-8 col-sm-9" style="float:left;width:800px;heigth:150px;" >
      ...
      <div class="_line formControls col-xs-8 col-sm-9"   id="act_notice_id"  style="float:left;width:900px;heigth:150px;display:none;border:1px solid red;"  >

                   
                     
                    <select id="bs3Select" class="selectpicker show-tick form-control" multiple name="actIDs[]" data-live-search="true">
               
                    <?php foreach ($actArr as $k=>$val){?>
    ...
    <div class="_line formControls col-xs-8 col-sm-9" style="float:left;width:600px;" >
		 ...
		 <label for="textfield" style="color:#00CC00;"> B.(选择后，该所属商家发布的所有活动将享受该优惠劵,[请只选择一个])</label>

    </div> 
    
    <div class="_line formControls col-xs-8 col-sm-9"   id="business_notice_id"   style="float:left;width:810px;heigth:150px;display:none;" >
                           <select id="bs3Select" class="selectpicker show-tick form-control" multiple name="business_ids" data-live-search="true">
               
                    <?php foreach ($user as $k=>$val){?>
                  <option value="<?php echo $val['id'] ?>"><?php if ($val['nickname']) {
                  		echo $val['nickname'];
                 	 }else if($val['account']){
                  		echo $val['account'];
                	  }else{
...
$("#onlyoneact").click(function(){
	...
	$("#act_notice_id").attr("style","display:block;width:900px;heigth:150px;border:0px solid red;padding-left:40px;")
	$("#business_notice_id").attr("style","display:none")
	if( strleng($("#business_ids").val()) > 0 ){	
	    $("#business_ids").val("");
	}
});
//style="float:left;width:900px;heigth:150px;display:none;border:1px solid red;
$("#is_business").click(function(){
	...
	$("#business_notice_id").attr("style","display:block;width:500px;heigth:150px;border:0px solid red;padding-left:40px;");
