...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 财务管理  <span class="c-gray en">&gt;</span> 交易流水   <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container"><form action="" method="get">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入关键字" id=""  value="<?php echo $search?>" name="search">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		<thead>
			<tr class="text-c">
				...
				<th width="80">活动名称</th>				
				<th width="90">所属分站</th>					
				<th width="150">好摄ID</th>
				<th width="200">用户昵称</th>
				<th width="130">收入订单</th>
				<th width="80">支出退单</th>
				<th width="70">交易时间</th>
				<th width="100">操作</th>
			</tr>
		...
		<tbody>
			<tr class="text-c">
				...
				<td> - </td>
				<td><?php echo $val['_uid']?></td>
				<td><?php echo getNickname($val['_uid'])?></td>
