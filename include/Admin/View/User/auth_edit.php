	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype=”multipart/form-data”>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="" id="phone" name="phone" value="<?php echo $info['phone']?>">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="nickname" id="account"  value="<?php echo $info['nickname']?>">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"> 职业：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" name="job" id="job" value="<?php echo $info['job']?>">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">上传头像：</label>
			<div class="formControls col-xs-8 col-sm-9">
			               <img style="width:100px; margin-bottom:16px; height:100px" id="img-avatar" src="<?php echo $info['avatar'];?>">
				           <div id="flash1">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<select class="select" size="1" name="user_type">
					<option value="1" <?php if($info['user_type'] == 1){echo 'selected';}?>>摄影师</option>
					<option value="2" <?php if($info['user_type'] == 2){echo 'selected';}?>>麻豆</option>
					<option value="3" <?php if($info['user_type'] == 3){echo 'selected';}?>>社会团体</option>
					<option value="5" <?php if($info['user_type'] == 4){echo 'selected';}?>>商业机构</option>
					<option value="5" <?php if($info['user_type'] == 5){echo 'selected';}?>>官方</option>
				</select>
			</div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="personality_sign" cols="" rows="" class="textarea"  placeholder="说点什么..." onKeyUp="textarealength(this,100)"><?php echo $info['personality_sign']?></textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})" name="birthday" id="birthday" class="input-text Wdate" value="<?php echo $info['birthday']?>" style="width:120px;">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> 
				<input class="input-text" type="text" placeholder="详细地址" name="address" id="name"  value="<?php echo $info['address']?>" style="width:360px">
			</div>
		</div>
		
       <div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">身份证件：</label><span style="font-size:14px; "><div id="uploader-demo" style="text-indent: 23px;padding-top:20px">  
    <!--用来存放item-->       
    <div>  
     ...
     <span id="ctlBtn" class="btn btn-success radius">开始上传</span>  
			...
			<div class="formControls col-xs-8 col-sm-9">
			<div id="thelist" class="uploader-list" style="margin-left:23px"> 
					
					<?php foreach ($au as $key => $item){?>
					<?php if($item['material_type'] == 1){?>
					<div id="WU_FILE_<?php echo $key?>" class="file-item thumbnail upload-state-done"><img width="120" height="120" src="<?php echo $item['path']?>"></div>
					<?php }}?>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">资质证件：</label>
			<span style="font-size:14px; "><div id="uploader-demo" style="text-indent: 23px;padding-top:20px">  
    <!--用来存放item-->       
    <div>  
     ...
     <span id="ctlBtn2" class="btn btn-success radius">开始上传</span>  
			...
			<div class="formControls col-xs-8 col-sm-9">
			<div id="thelist2" class="uploader-list" style="margin-left:23px">
				 					
					<?php foreach ($au as $key => $item){?>
					<?php if($item['material_type'] == 2) {?>
					<div id="WU_FILE_<?php echo $key?>" class="file-item thumbnail upload-state-done"><img width="120" height="120" src="<?php echo $item['path']?>"></div>
					<?php }}?>
