...
<div class="warp">
    ...
    <div id="_end" class="_line formControls col-xs-8 col-sm-9"><label for="textfield">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目的地址：</label>
     <div id="result" style="display:none"></div>
    <span id="city_3"><select class="prov" name="end_province"></select> <input type="hidden" name="_end_" id="_end_" value="" />
	<select class="city" name="end_city" disabled="disabled"></select>
	<select class="dist" name="end_county" disabled="disabled"></select> <input type="text" name="end_address" id="_address" class="input-text" style="width:170px"  /></span>
    </div>
    <div class="row cl">
    ...
    <div class="_line formControls col-xs-8 col-sm-9"><label for="textfield">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;活动频道：</label>
        <select name="channel_id" id="channel_id">
              ...
              <select name="go_type" id="go_type">
                  <option value="常规" <?php if($info['go_type'] == '常规') echo 'selected'?>>常规</option>
                  <option value="徒步" <?php if($info['go_type'] == '徒步') echo 'selected'?>>徒步</option>
                  <option value="骑行" <?php if($info['go_type'] == '骑行') echo 'selected'?>>骑行</option>
                  <option value="自驾" <?php if($info['go_type'] == '自驾') echo 'selected'?>>自驾</option>
              </select>
    </div>
...
<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				...
				<img src="<?php echo $info['face']?>" style="" /></div>
			</div>
		</div>
        ...
        <div class="_line formControls col-xs-8 col-sm-9">
			   <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;活动费用：</label>
               <input type="text" class="input-text" style="width: 100px" id="equipment" name="activity_price"  value="<?php echo $info['activity_price']?>"> <label>元 / 人&nbsp;&nbsp;&nbsp;&nbsp;</label> 
               <label>活动人数：</label>
    ...
    <div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
       		...
       		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			    <input name="postion" type="hidden" id="postion" size="8" /><input type="hidden" name="face" id="but" value="<?php echo $info['face']?>" />
...
$(function(){
	...
	$("#city_3").citySelect({
		prov:"<?php echo $info['end_province']?>", 
    	city:"<?php echo $info['end_city']?>",
		dist:"<?php echo $info['end_county']?>", 
		nodata:"none"
	});
