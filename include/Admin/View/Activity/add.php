...
<!-- script type="text/javascript" src="http://webapi.amap.com/maps?v=1.3&key=64f731cf2ac66b4949818c73c57ef4df&plugin=AMap.PlaceSearch"></script--> 
...
<div class="warp">
    ...
    <div class="_line formControls col-xs-8 col-sm-9" style="float:left;width:800px;" ><label for="textfield">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;活动地址：</label>
	    <span id="city_4"><select class="prov" id="prov" name="province"></select> 
			...
			<input type="text" id="address" name="address" class="input-text" style="width:19%" value=""/>
    ...
    <div style="display:none" id="_end" class="_line formControls col-xs-8 col-sm-9"><label for="textfield">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目的地址：</label>
    <span id="city_3">
        <select class="prov" name="end_province"></select>      
		<select class="city" name="end_city" disabled="disabled"></select>
		<select class="dist" name="end_county" disabled="disabled"></select>
		<input type="text" name="end_address" id="end_address" class="input-text" style="width:170px"  />
		<input type="hidden" name="_end_" id="_end_" value="" />
	</span>
...
<div class="row cl">
        ...
        <div class="_line formControls col-xs-8 col-sm-9">
			   <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;活动费用：</label>
               <input type="text" class="input-text" style="width: 100px" id="equipment" name="activity_price"> <label>元 / 人&nbsp;&nbsp;&nbsp;&nbsp;</label> 
               <label>活动人数：</label>
...
//     geolocation.getCurrentPosition(callback:function(status,result){
// 		alert(result);
//     });
...
var map = new AMap.Map('container',{
    resizeEnable: true,
    zoom: 13,
    center: [113.9467138643,22.5534391488]
});
