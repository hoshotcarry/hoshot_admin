...
<!-- 		<div class="row cl"> -->
<!-- 			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>摄点频道：</label> -->
<!-- 			<div class="formControls col-xs-8 col-sm-9"> -->
<!-- 				<select class="select" size="1" name="cat_id"> -->
<!-- 					<?php foreach ($category as $c => $r){?>
<!--                    <option value="<?php echo $r['id']?>" <?php if($r['id'] == $info['cat_id']) echo 'selected'?>><?php echo $r['title']?></option>
<!--                     <?php }?>
<!-- 				</select> -->
<!-- 			</div> -->
<!-- 		</div> -->
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>推荐位置：</label>
			<div class="formControls col-xs-8 col-sm-9">
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" value="<?php echo $info['equipment'];?>" placeholder="输入推荐器材" id="equipment" name="equipment">
			</div>
		 </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="select" size="1" name="season" style="width:200px">
                    <option value="全部季节" <?php if($info['season'] == '全部季节') echo 'selected';?>>全部季节</option>
					<option value="春" <?php if($info['season'] == '春') echo 'selected';?>>春</option>
					<option value="夏" <?php if($info['season'] == '夏') echo 'selected';?>>夏</option>
                    <option value="秋" <?php if($info['season'] == '秋') echo 'selected';?>>秋</option>
					<option value="冬" <?php if($info['season'] == '冬') echo 'selected';?>>冬</option>
				</select>    <select class="select" size="1" name="weather" style="width:200px">
					<option value="全部天气" <?php if($info['weather'] == '全部天气') echo 'selected';?>>全部天气</option>
					<option value="晴" <?php if($info['weather'] == '晴') echo 'selected';?>>晴</option>
					<option value="风" <?php if($info['weather'] == '风') echo 'selected';?>>风</option>
					<option value="云" <?php if($info['weather'] == '云') echo 'selected';?>>云</option>
					<option value="雾 <?php if($info['weather'] == '雾') echo 'selected';?>">雾</option>
					<option value="雨" <?php if($info['weather'] == '雨') echo 'selected';?>>雨</option>
					<option value="雪" <?php if($info['weather'] == '雪') echo 'selected';?>>雪</option>
					<option value="霜" <?php if($info['weather'] == '霜') echo 'selected';?>>霜</option>
				</select>
			</div>
		</div>
         ...
         <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="select" size="1" name="recom_time" style="width:200px">
                    <option value="任何时间" <?php if($info['recom_time'] == '任何时间') echo 'selected';?>>任何时间</option>
					<option value="日出" <?php if($info['recom_time'] == '日出') echo 'selected';?>>日出</option>
					<option value="晨" <?php if($info['recom_time'] == '晨') echo 'selected';?>>晨</option>
                    <option value="午" <?php if($info['recom_time'] == '午') echo 'selected';?>>午</option>
                    <option value="傍晚" <?php if($info['recom_time'] == '傍晚') echo 'selected';?>>傍晚</option>
                    <option value="夜" <?php if($info['recom_time'] == '夜') echo 'selected';?>>夜</option>
				</select>
			</div>
		 </div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="remark" cols="" rows="" class="textarea"  placeholder="说点什么..." onKeyUp="textarealength(this,100)"><?php echo $info['remark']?></textarea>
				<p class="textarea-numberbar"><em class="textarea-length">0</em>/100</p>
			</div>
		</div>
<!--        <div class="row cl"> -->
<!-- 			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>摄点标签：</label> -->
<!-- 			<div class="formControls col-xs-8 col-sm-9"> -->
...
<div class="row cl">
    ...
    <div>  
     ...
     <span id="ctlBtn" class="btn btn-success radius">开始上传</span>  
			...
			<div class="formControls col-xs-8 col-sm-9"><div id="thelist" class="uploader-list" style="margin-left: 23px">
				<?php foreach ($images as $k => $v){?>
				<img class="old_img" alt="" width="120" height="120" src="<?php echo $v['path']?>">
				<?php }?>
			</div></div>
		</div>
		...
		<div class="row cl">
			...
			<input name="postion" type="hidden" id="postion" size="8" value="<?php echo $info['longitude']?>,<?php echo $info['latitude']?>" />
