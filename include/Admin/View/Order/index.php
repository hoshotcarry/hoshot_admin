...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 财务管理 <span class="c-gray en">&gt;</span> 订单管理   <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container"><form action="" method="get">
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="订单名称" id=""  value="<?php echo $search?>" name="search">
	...
	<table class="table table-border table-bordered table-hover table-bg">
		...
		<tbody>
			<tr class="text-c">
				...
				<td><a href="javascript:viod(0)" id="member_show" onclick="member_show()"><?php echo $val['order_number']?></a></td>
				<td><?php echo get_account($val['user_id'])?></td>
				<td><?php echo $val['order_title']?></td>
				<td><?php echo $val['money']?></td>
				<td><?php if($val['status'] == 1){echo '已支付';}elseif($val['status'] == 0){echo '待付款';}elseif($val['status'] == -1){echo '已取消';}?></td>
				<td><?php echo $val['pay_type']?></td>
				<td><?php echo date("Y-m-d H:i:s",$val['order_time'])?></td>
				<td><?php echo date("Y-m-d H:i:s",$val['pay_time'])?></td>
				<th width="70"><?php echo $val['remark']?></th>
