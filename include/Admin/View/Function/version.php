...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 功能管理 <span class="c-gray en">&gt;</span> APP版本管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<!--    <form action="" method="get">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" id="delete" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('发布新版本','/admin/Function/version_add','','580')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 发布新版本</a></span> <span class="r">共有数据：<strong><?php echo $total;?></strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		<thead>
			<tr class="text-c">
				...
				<th width="80">编号</th>
				<th width="100">APP ID号</th>
				<th width="90">上传平台</th>					
				<th width="150">版本号</th>
				<th width="200">版本说明</th>
				<th width="100">操作</th>
			</tr>
		</thead>
		...
		<tbody>
			<tr class="text-c">
				...
				<td><?php echo $val['flatform'] == 1 ? 'IOS' : "Android"; ?></td>
				<td><?php echo $val['app_version']?></td>
				<td><?php echo $val['remark'] ?></td>
				<td class="td-manage"> <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/admin/Function/version_edit?id=<?php echo $val['id']?>','4','','600')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a></td>
			</tr>
		</tbody>
		<?php }?>
	</table>
...
$("#delete").click(function(){
	layer.confirm('确认要删除吗？',function(index){
        ...
        $.post('/admin/Function/version_del',{id:delID},function(data){
