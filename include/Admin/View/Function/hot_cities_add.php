...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
                            <input id="sort_order" name="sort_order" type="text" value="" />
			</div>
                </div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
				...
				<input class="btn btn-primary radius" id="submit-form" type="submit" value="&nbsp;&nbsp;提交&nbsp;&nbsp;">
			</div>
		</div>
	</form>
</article>
...
<script type="text/javascript" src="/static/js/jquery.cityselect_1.js"></script>
...
$(function(){
	...
	$('.skin-minimal input').iCheck({
        ...
        $('#submit-form').on('click',function (){
            $('#city_id').val($('#city option:selected').attr('city'));
        })
