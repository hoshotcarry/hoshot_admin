...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 功能管理 <span class="c-gray en">&gt;</span> 热门城市管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
		...
		<tbody>
			<tr class="text-c">
				...
				<td class="td-manage"> 
                                    ...
                                    <?php }?>
                                    <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/admin/Function/hot_cities_edit?id=<?php echo $val['id']?>','4','','600')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                                </td>
			</tr>
		</tbody>
		<?php }?>
...
$("#delete").click(function(){
	layer.confirm('确认要删除吗？',function(index){
        ...
        $.post('/admin/Function/hot_cities_del',{id:delID},function(data){
...
function member_stop(obj,id){
	layer.confirm('确认要禁用吗？',function(index){
		$.get('/admin/Function/hot_cities_stop?id='+id,function(data){
...
function member_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		$.get('/admin/Function/hot_cities_start?id='+id,function(data){
                    if(data.status){
