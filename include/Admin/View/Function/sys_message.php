...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 功能管理 <span class="c-gray en">&gt;</span>系统消息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<tr class="text-c">
				...
				<td class="td-status"><?php echo $val['status'] == 0 ? '未发布' : '已发布' ?></td>
				...
				<td class="td-manage">
                                    ...
                                    <?php }else{ ?>
                                        <a style="text-decoration:none;" onClick="member_start(this,'<?php echo $val['id']?>')" href="javascript:;" title="发布"><i class="Hui-iconfont">&#xe6e1;</i></a>
                                    <?php }?>
                                        <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/admin/Function/sys_message_edit?id=<?php echo $val['id']?>','4','','600')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
                                </td>
			</tr>
		</tbody>
		<?php }?>
...
function member_stop(obj,id){
	layer.confirm('确认要停用吗？',function(index){
		$.get('/admin/Function/sys_message_stop?id='+id,function(data){
                    if(data.status){
                        $(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none;" onClick="member_start(this,'+id+')" href="javascript:;" title="启用"><i class="Hui-iconfont">&#xe6e1;</i></a>');
                        $(obj).parents("tr").find(".td-status").html('<span class="label label-defaunt radius">已停用</span>');
                        $(obj).remove();
                        layer.msg('未发布!',{icon: 6,time:1000});
                    }else{
...
function member_start(obj,id){
	layer.confirm('确认要启用吗？',function(index){
		$.get('/admin/Function/sys_message_start?id='+id,function(data){
                    if(data.status){
                        $(obj).parents("tr").find(".td-manage").prepend('<a style="text-decoration:none;" onClick="member_stop(this,'+id+')" href="javascript:;" title="停用"><i class="Hui-iconfont">&#xe631;</i></a>');
                        $(obj).parents("tr").find(".td-status").html('<span class="label label-defaunt radius">已启用</span>');
                        $(obj).remove();
...
$("#delete").click(function(){
	layer.confirm('确认要删除吗？',function(index){
        ...
        $.post('/admin/Function/sys_message_del',{id:delID},function(data){
