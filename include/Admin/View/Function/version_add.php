	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea type="text" class="textarea" placeholder="请版本更新说明" id="remark" name="remark" value=""></textarea>
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="app_version" id="app_version" value="">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"  name="app_id" id="app_id" value="">
				<input type="hidden" name="logo" id="logo" value="">
			</div>
		</div>
		<!-- div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>APP LOGO：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>上传版本：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<!-- div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" onfocus="WdatePicker({minDate:'%y-%M-%d',dateFmt:'yyyy/MM/dd HH:mm:ss'})" name="online_time" id="online_time" class="input-text Wdate" value="" style="width:220px;">
			</div>
		</div> -->
		
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			<input class="input-text" type="hidden" name="id" value="">
