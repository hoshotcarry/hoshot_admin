...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 功能管理 <span class="c-gray en">&gt;</span> 标签管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<!--    <form action="" method="get">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" id="delete" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('新增标签','/admin/Function/tags_add','','580')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 新增标签</a></span> <span class="r">共有数据：<strong><?php echo $total;?></strong> 条</span> </div>
	<div class="mt-20">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<tr class="text-c">
				...
				<td><?php echo $val['countHits']?></td>
                                <td><?php echo $model_data[$val['moduleType']];?></td>
				<td><?php echo date('Y-m-d h:m:i' ,$val['create_time'])?></td>
				<td class="td-manage"> <a title="编辑" href="javascript:;" onclick="member_edit('编辑','/admin/Function/tags_edit?id=<?php echo $val['id']?>','4','','600')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a></td>
			</tr>
		</tbody>
		<?php }?>
	</table>
...
function member_stop(obj,id){
	layer.confirm('确认要停用吗？',function(index){
		$.get('/admin/Function/tags_enb?id='+id,function(data){
...
$("#delete").click(function(){
	layer.confirm('确认要删除吗？',function(index){
        ...
        $.post('/admin/Function/tags_del',{id:delID},function(data){
