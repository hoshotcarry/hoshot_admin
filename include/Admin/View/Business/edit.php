	...
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $bus['name']?>"  placeholder="" id="title" name="name">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" id="address" placeholder="输入商家地址" id="equipment" name="address"  style="width:80%;" value="<?php echo $bus['address']?>">
               
               <input type="hidden" name="longitude" id="longitude" class="input-text" style="width:19%" value="<?php echo $bus['longitude']?>" />
			   <input type="hidden" name="latitude" id="latitude" class="input-text" style="width:19%" value="<?php echo $bus['latitude']?>" />
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" maxlength="15" value="<?php echo $bus['phone']?>" id="equipment" name="phone">
			</div>
		 </div>
		...
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			    <input name="postion" type="hidden" id="postion" size="8" value="<?php echo $bus['addrss']?>,<?php echo $bus['addrss']?>" />
