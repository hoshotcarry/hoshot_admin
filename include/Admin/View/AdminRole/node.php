...
<div class="page-container">
	...
	<dl class="checkmod">
							<dt class="hd">
								<label class="checkbox"><input class="auth_rules rules_all" type="checkbox" name="rules[]" value="<?php echo $n['id']?>" <?php if(in_array($n['id'],$node)){echo 'checked';}?>><?php echo $n['nodeName']?></label>
							</dt>
							...
							<dd class="bd">
								...
								<div class="rule_check">
                                        <div>
                                           ...
                                           <input class="auth_rules rules_row" type="checkbox" name="rules[]" value="<?php echo $s['id']?>" <?php if(in_array($s['id'],$node)){echo 'checked';}?>><?php echo $s['nodeName']?>                                       </label>
                                        </div>
                                       <span class="divsion">&nbsp;</span>
                                           <span class="child_row">
                                           <?php foreach (node($s['id']) as $k => $i){?>
                                               <label class="checkbox"><input class="auth_rules" type="checkbox" name="rules[]" value="<?php echo $i['id']?>" <?php if(in_array($i['id'],$node)){echo 'checked';}?>><?php echo $i['nodeName']?>  </label>
                                           <?php }?>
                                           </span>				                    
                                    </div>
						            <?php }?>
...
$("#power").click(function(){
	layer.confirm('确认要更新吗？',function(index){
        ...
        $.post('/admin/Node/update_power?rid=<?php echo $_GET['rid']?>',{id:updID},function(data){      
