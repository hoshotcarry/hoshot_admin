...
<article class="page-container">
	<form action="/admin/Works/edit?id=<?php echo $info['id']?>" method="post" class="form form-horizontal" id="form-member-add">

		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>选择活动：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $act_title?>" placeholder="" id="name" name="name">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select name="related_shoot" id="related_shoot">
                        <option value="0">无</option>
                        <?php foreach($shoot as $sh){?>
                        <option value="<?php echo $sh['id']?>" <?php if($sh['id'] == $info['related_shoot']) echo 'selected';?>><?php echo $sh['title']?></option>
                        <?php }?>
                        </select>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
              <input type="checkbox" name="copyright" id="checkbox" <?php if($info['copyright'] == 1) echo 'checked';?>>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			  ...
			  <input type="checkbox" name="checkbox[<?php echo $item['id']?>]" id="checkbox" <?php if(in_array($item['id'],json_decode($info['tags']))) echo 'checked';?>>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="title" cols="" rows="" class="textarea"  placeholder="说点什么..." onKeyUp="textarealength(this,500)"><?php echo $info['title']?></textarea>
    ...
    <div>  
     ...
     <span id="ctlBtn" class="btn btn-success radius">开始上传</span>  
			...
			<div class="formControls col-xs-8 col-sm-9"><div id="thelist" class="uploader-list" style="margin-left: 23px">
				...
				<img alt="" src="<?php echo $item['path']?>">
				<?php }?>
			</div></div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			    ...
			    <input type="hidden" class="input-text" value="<?php echo $info['act_id']?>" placeholder="" id="_name" name="act_id">
