...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  name="account" id="account" style="width:70%;">
		</div>		
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="mobilephone" name="mobilephone" style="width:70%;">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>电话号码：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="phone" name="phone" style="width:70%;">
			</div>
		</div>		
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
			   ...
			   <?php foreach ($typeArr as $k=>$val){?>
                  <option value="<?php echo $val['filiale_id'] ?> " style="width:30%;"><?php echo $val['name'] ?> </option>
               <?php } ?>   
