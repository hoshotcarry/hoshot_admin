	   ...
	   <div class="row cl">
		...
		<div class="row cl">
		    <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>广告开始投放时间：</label>
			   <input type="text" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd'})" name="start_time" id="datemin" class="input-text Wdate" style="width:120px;">
				    &nbsp;&nbsp;&nbsp;广告结束投放时间：
				<input type="text" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd'})"  name="end_time" id="datemax" class="input-text Wdate" style="width:120px;">
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>广告PC端：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="" id="phone" name="phone"> 
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>广告移动端：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="hidden" class="input-text" value="" id="phone" name="phone"> 
			</div>
		</div>
		<div class="row cl">
			<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-3">
			    <input type="hidden" name="user_id" value="<?php echo session('user_auth')['uid'];?>">
