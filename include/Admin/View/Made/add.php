...
<article class="page-container">
	<form action="" method="post" class="form form-horizontal" id="form-member-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text"   value="10000001" id="title" name="user_id">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" id="address" placeholder="输入姓名" id="equipment" name="name">
			</div>
		 </div>
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" placeholder="输入电话" id="equipment" name="phone">
			</div>
		 </div>
         ...
         <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="输入人数" id="title" name="people">
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="1" id="title" name="days">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" id="address" placeholder="输入价格" id="equipment" name="price">
			</div>
		 </div>
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text"  id="equipment" name="more">
			</div>
		 </div>
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="input-text" id="nature" name="nature">
                       <option value="公司奖励">公司奖励</option>
                       <option value="机构员工">机构员工</option>
                       <option value="商务会议">商务会议</option>
                       <option value="年末会议">年末会议</option>
                       <option value="业余培训">业余培训</option>
                       <option value="其他">其他</option>
                </select>
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="input-text" id="model" name="traffic">
                       ...
                       <option value="火车/高铁">火车/高铁</option>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <select class="input-text" id="model" name="hotel">
                       <option value="豪华五星">豪华五星</option>
                       <option value="豪华四星">豪华四星</option>
                       <option value="高级三星">高级三星</option>
                       <option value="特色酒店">特色酒店</option>
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<select class="input-text" id="model" name="dining">
                       <option value="顶级餐厅">顶级餐厅</option>
                       <option value="当地风味">当地风味</option>
                       <option value="其他">其他</option>
                </select>
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <select class="input-text" id="model" name="visa">
                       ...
                       <option value="需要办理">需要办理</option>
                       <option value="自行办理">自行办理</option>
                </select>
			</div>
		 </div>
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" placeholder="输入目的地" name="destination">
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" id="address" placeholder="输入起始地" id="equipment" name="start_adress">
			</div>
		 </div>
		 ...
		 <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input type="text" class="input-text" id="address" placeholder="输入我的地址" id="equipment" name="address">
			</div>
		 </div>
		  ...
		  <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input name="start_time" type="text" id="start_time" size="15" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm'})"/>
			</div>
		</div>
        ...
        <div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
               <input name="end_time" type="text" id="end_time" size="15"  class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy/MM/dd HH:mm'})" />
			</div>
		 </div>
