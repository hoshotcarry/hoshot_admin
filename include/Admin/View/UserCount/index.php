...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 统计管理 <span class="c-gray en">&gt;</span> 用户统计   <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">  <input type="text" onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'datemax\')||\'%y-%M-%d\'}'})" name="start_time" id="datemin" class="input-text Wdate" value="<?php echo $start_time?>" style="width:120px;">
        ...
        <select name="select5" id="select5" class="input-text" style="width:150px">
                  <option value="0">请选筛选条件</option>
        </select>
		<button type="submit" class="btn btn-success radius" id="" name="" value=""><i class="Hui-iconfont">&#xe665;</i> 查询 </button> </div>
	<p><br/></p>
	<table class="table table-border table-bordered table-hover table-bg">
		<thead>
			<tr class="text-c">
				<th width="25">日期</th>
				<th width="100">页面浏览量（PV）</th>
				<th width="100">独立访客数（UV）</th>
				<th width="100">独立IP数（IP）</th>
				<th width="100">总注册用户数</th>
		...
		<tbody>
			<tr class="text-c">
				...
				<td><?php echo $val['uv']?></td>
				<td><?php echo $val['ip']?></td>
				<th><?php echo $val['all']?></th>
				<th><?php echo $val['count']?></th>
				</tr>
		</tbody>
		<?php }?>
	</table>
